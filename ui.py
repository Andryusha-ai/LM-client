...
class ChatUI(QMainWindow):
    ...
    def __init__(self, config, parent=None):
        ...
        # Создаём глобальный шорткат для PrtSc
        self.prtsc_shortcut = QShortcut(QKeySequence("Print"), self)
    ...
    def _on_prtsc_pressed(self):
        """Эмуляция нажатия PrtSc через Lightshot"""
        # Симулируем нажатие клавиши PrtSc на системном уровне
        import ctypes
